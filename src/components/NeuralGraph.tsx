...
const NeuralGraph: React.FC = () => {
  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute bottom-2 right-2 text-[8px] text-[#06af6e]/60 font-mono">
        {renderMode.type.toUpperCase()} MODE - DETAIL: {renderMode.detailLevel}
      </div>
    </div>
  );
};
