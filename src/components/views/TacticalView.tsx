      ...
      <div className="lg:col-span-3 flex flex-col gap-6">
        <section className="bg-[#06af6e]/5 border border-[#06af6e]/20 p-5 brutalist-border">
          ...
          <p className="text-[10px] text-gray-500 leading-relaxed mb-4">
            ...
            <span className="text-[#06af6e]">32,768</span> tokens for structural
            reasoning and Omega Invariant verification.
          </p>
        ...
        <section className="bg-red-500/5 border border-red-500/20 p-5 brutalist-border">
          ...
          <p className="text-[10px] text-gray-500 leading-relaxed">
            All tactical outputs are bound to the Zero-Entropy Law.
            Hallucination thresholds are monitored at sub-nanosecond latency
            with immediate kernel veto on non-deterministic branches.
          </p>
        </section>
